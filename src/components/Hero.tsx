  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-800">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-5 sm:left-10 w-72 h-72 sm:w-96 sm:h-96 bg-gradient-to-br from-emerald-400/20 to-blue-500/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-5 sm:right-10 w-96 h-96 sm:w-[500px] sm:h-[500px] bg-gradient-to-br from-blue-400/15 to-emerald-500/15 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] sm:w-[800px] sm:h-[800px] bg-gradient-to-br from-green-400/10 to-blue-400/10 rounded-full blur-3xl animate-pulse delay-500"></div>
      </div>
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-center mb-8 sm:mb-12 animate-fade-in">
          ...
          <div className="ml-3 sm:ml-4 flex flex-col items-start">
            <span className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-white via-emerald-200 to-blue-200 bg-clip-text text-transparent tracking-tight">
              Tech Harvest
            </span>
            <span className="text-emerald-300/80 text-xs sm:text-sm font-medium tracking-widest uppercase">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center animate-fade-in delay-500 mb-12 sm:mb-16 px-4">
          <Button 
            size="lg" 
            className="group relative bg-gradient-to-r from-emerald-500 to-blue-500 hover:from-emerald-400 hover:to-blue-400 text-white px-8 sm:px-10 py-4 sm:py-6 text-base sm:text-lg rounded-2xl shadow-2xl hover:shadow-emerald-500/25 transition-all duration-500 hover:scale-105 font-semibold tracking-wide w-full sm:w-auto"
          >
          ...
          <Button 
            variant="outline" 
            size="lg"
            className="group border-2 border-emerald-400/50 text-emerald-200 hover:bg-emerald-500/10 hover:border-emerald-300 px-8 sm:px-10 py-4 sm:py-6 text-base sm:text-lg rounded-2xl transition-all duration-500 hover:scale-105 backdrop-blur-sm font-semibold tracking-wide w-full sm:w-auto"
          >
            See What's Growing
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 animate-fade-in delay-700 px-4">
          <div className="group relative bg-white/5 backdrop-blur-xl rounded-3xl p-6 sm:p-8 border border-white/10 hover:bg-white/10 transition-all duration-500 hover:scale-105">
            ...
            <div className="relative z-10">
              <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-emerald-300 to-emerald-100 bg-clip-text text-transparent mb-2 sm:mb-3">10K+</div>
          ...
          <div className="group relative bg-white/5 backdrop-blur-xl rounded-3xl p-6 sm:p-8 border border-white/10 hover:bg-white/10 transition-all duration-500 hover:scale-105">
            ...
            <div className="relative z-10">
              <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-blue-300 to-blue-100 bg-clip-text text-transparent mb-2 sm:mb-3">95%</div>
          ...
          <div className="group relative bg-white/5 backdrop-blur-xl rounded-3xl p-6 sm:p-8 border border-white/10 hover:bg-white/10 transition-all duration-500 hover:scale-105">
            ...
            <div className="relative z-10">
              <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-green-300 to-green-100 bg-clip-text text-transparent mb-2 sm:mb-3">50+</div>
      ...
      <div className="absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <div className="bg-white/10 backdrop-blur-sm rounded-full p-2 sm:p-3 border border-white/20">
          <ChevronRight className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-300 rotate-90" />
        </div>
      </div>
    </section>
  );
